        ...
        <ul>
          ...
          {avisos.map((aviso) => {
            ...
            return (
              <li
                key={aviso.id}
                className="py-5 border-b flex flex-col gap-2 border-slate-200 px-5"
              >
